                                  ...
                                  Builder(builder: (BuildContext context) {
                                    if (sheetState is NoTemplateState) {
                                      return RaisedButton(
                                        ...
                                        onPressed: () {
                                          BlocProvider.of<SheetBloc>(context)
                                              .dispatch(CreateTemplateFileEvent(
                                                  state.headers));
                                        },
                                      );
                                    } else if (sheetState
                                        is TemplateReadyState) {
                                      return RaisedButton(
                                        child: Text(locText(context,
                                                key: "templateRemove")
                                            .toUpperCase()),
